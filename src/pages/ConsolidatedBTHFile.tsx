...
export default function ConsolidatedBTHFile() {
  ...
  const handleDownload = () => {
    ...
    const filename = `2294${dd}${yy}_ConsolBTH.001`;
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Consolidated BTH File</h1>
          <p className="text-sm text-gray-500">Download consolidated bank payment file for all BTH payments made on a given date</p>
        </div>
      </div>
