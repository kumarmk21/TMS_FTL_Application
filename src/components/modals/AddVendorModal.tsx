...
export function AddVendorModal({ isOpen, onClose, onSuccess }: AddVendorModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      let pan_document_url = null;
      let cancelled_cheque_url = null;
      let tds_declaration_url = null;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="info@dlslogistics.in"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <Upload className="w-4 h-4 text-gray-500" />
                    <span className="text-sm text-gray-600">
                      {files.cancelled_cheque ? files.cancelled_cheque.name : 'Choose File'}
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <label
                    htmlFor="tds_declaration"
                    className="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors"
                  >
                    <Upload className="w-4 h-4 text-gray-500" />
                    <span className="text-sm text-gray-600">
                      {files.tds_declaration ? files.tds_declaration.name : 'Choose File'}
                    </span>
                  </label>
                </div>
              </div>
