...
interface AddOrderEnquiryModalProps {
  onClose: () => void;
  onSuccess: () => void;
}
...
export function AddOrderEnquiryModal({ onClose, onSuccess }: AddOrderEnquiryModalProps) {
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({ ...prev, loading_date: today }));
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.from('order_enquiry').insert({
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">New Order/Enquiry</h2>
          <button
            onClick={onClose}
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setFormData({ ...formData, origin_id: '' });
                }}
